...
This is a frontend boilerplate, based on `ionic start` and customized by [Carbonaut](http://carbonaut.io/). It uses [Ionic 5](https://ionicframework.com/), [Angular 8](http://angular.io/) and [Node.js](https://nodejs.org/en/) 12.\*.(for CI)
